...
This is the canonical routing file for all coding agents working in `agent-blackboard`.

Keep this file short. Put detailed governance rules in `docs/governance/` and use this file to route agents to the right workflow.
...
| Bug fix or small behavior tweak | `docs/governance/compact-specs.md` |
...
- Start local-first before remote or multi-machine support.
- Do not add arbitrary sandboxed frontend apps in the MVP.
- Keep the agent-facing skill concise and example-driven.
- Treat public protocols, CLI commands, persisted state, and skill instructions as project surface.
